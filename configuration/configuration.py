...
REMOTE_AUTH_BACKEND = _environ_get_and_map(
    "REMOTE_AUTH_BACKEND", "netbox.authentication.RemoteUserBackend", _AS_LIST
)
...
SOCIAL_AUTH_OKTA_OPENIDCONNECT_SECRET = _read_secret(
    ...
    environ.get("SOCIAL_AUTH_OKTA_OPENIDCONNECT_SECRET", ""),
)
SOCIAL_AUTH_OKTA_OPENIDCONNECT_API_URL = environ.get(
...
SOCIAL_AUTH_OIDC_SECRET = _read_secret(
    "oidc_secret", environ.get("SOCIAL_AUTH_OIDC_SECRET", "")
)
SOCIAL_AUTH_OIDC_SCOPE = _environ_get_and_map("SOCIAL_AUTH_OIDC_SCOPE", "", _AS_LIST)
LOGOUT_REDIRECT_URL = environ.get("LOGOUT_REDIRECT_URL", "/")
SOCIAL_AUTH_OIDC_JWT_ALGORITHMS = _environ_get_and_map(
    "SOCIAL_AUTH_OIDC_JWT_ALGORITHMS", "RS256", _AS_LIST
)
...
SECURE_HSTS_INCLUDE_SUBDOMAINS = _environ_get_and_map(
    "SECURE_HSTS_INCLUDE_SUBDOMAINS", "False", _AS_BOOL
)
